            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h2 class="fw-bold text-dark mb-0">
                        <i class="fas fa-users text-primary me-2"></i> Қолданушы қосу
                    </h2>
                </div>
                <div class="col-sm-6">
            ...
            <div class="card card-primary">
                <form method="post" @submit.prevent="submit">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="login-phone">Телефон нөмірі <span class="text-danger">*</span></label>
                            <input type="tel" class="form-control" v-model="user.phone" name="phone" id="login-phone" v-mask="'+7(7##) ### ##-##'" placeholder="+7(7__) ___ __-__" autocomplete="off" />
