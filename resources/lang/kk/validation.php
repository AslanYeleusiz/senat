...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'curator_id' => [
            'required' => ' Куратор тандалу керек.'
        ],
        'file' => [
            'required' => ' Файл тандалу керек.'
        ],
        'project_type' => [
            'required' => ' Проект типі тандалу керек.'
        ],
        'country' => [
            'required' => ' Елі тандалу керек.'
        ],
    ...
    */
    ...
    'attributes' => [
        ...
        'job_title' => 'Лауазым',
        'phone' => 'Телефон номер',
        'real_password' => 'Құпия сөз',
        'description' => 'Түсініктеме',
        'invest_sum' => 'Инвестиция сумма',
        'people_count' => 'Жұмыскерлер саны',
    ],
];
